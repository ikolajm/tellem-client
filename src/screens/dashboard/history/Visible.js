...
import visibleLoad from "../../../helpers/dashboard/history/load/visible";
import { TiGroup } from "react-icons/ti";
import { AiFillMessage } from "react-icons/ai";
import { FaArchive } from "react-icons/fa";
import moment from "moment";
import { Link } from "react-router-dom";
import archiveItem from "../../../helpers/dashboard/history/action/archive";

export default ({user}) => {
    const [data, setData] = useState(null)

    useEffect(async () => {
        let response = await visibleLoad();
        setData(response)
    }, [])
                                ...
                                return (
                                    <div className="conversation-item">
                                        ...
                                        <div className="button-nav">
                                            ...
                                            {/* Archive */}
                                            <button onClick={(e) => archiveItem(e, conversation)}><FaArchive /></button>
                                        </div>
                                    </div>
                                )
                            })
